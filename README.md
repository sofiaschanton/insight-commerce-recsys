...
> **ML Consulting Services:** Solución integral de _Next-Basket Recommendation_ con arquitectura MLOps desplegada en AWS.
...
- **Hiper-Personalización Basada en Evidencia:** El análisis de bimodalidad temporal (ciclos de 7 y 30 días) identificado en nuestro [Informe de EDA](./docs/Informe_EDA.md) permite al modelo actuar en el momento exacto de necesidad del cliente, aumentando el _Ticket Promedio_ y la tasa de retención.
...
- **Experiment Tracking:** Gestión de experimentos con **MLflow** para trazabilidad completa de parámetros, métricas y artefactos.
- **Monitoreo:** Detección de _Drift_ mediante **PSI** y **KS-test** ([Ver monitoreo](./src/model_monitoring.py)).
...
9. [MLflow: corridas y métricas](#mlflow-corridas-y-métricas)
10. [Variables de entorno](#variables-de-entorno)
11. [Estructura del proyecto](#estructura-del-proyecto)
12. [Pipeline de ejecución](#pipeline-de-ejecucion)
13. [Base de datos](#base-de-datos)
14. [Modelo](#modelo)
15. [MLOps Lifecycle](#mlops-lifecycle)
16. [Architecture Overview](#architecture-overview)
17. [Key Features](#key-features)
18. [Artifact Strategy](#artifact-strategy)
19. [Cloud Deployment](#cloud-deployment)
20. [Serving Layer](#serving-layer)
21. [Git Workflow -- Ramas y Pull Requests](#git-workflow----ramas-y-pull-requests)
...
Abrir en el navegador (por default):

```text
http://127.0.0.1:5000
```

### 3. Ejecutar una corrida (opcional)

clic del boton "run all" de /notebooks/04_modelado.ipynb

### 4. Ver métricas en la UI

- Ingresar en http://127.0.0.1:5000/#/experiments o hacer clic en el boton "Experiments"
- Selecciona un experimento deseas, ejemplo: `CatBoost Baselines`.
- Clic en Run name típico: `CatBoost`.
- Visualiza las Métricas registradas en la seccion Overview o en la seccion "Model Metrics": `precision`, `recall`, `f1`, `auc`.
